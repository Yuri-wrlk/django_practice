# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-07-25 09:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief description od the book', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language', models.CharField(help_text='Enter a language in format language-country (e.g. pt-BR, en-US):', max_length=5)),
            ],
        ),
        migrations.AddField(
            model_name='book',
